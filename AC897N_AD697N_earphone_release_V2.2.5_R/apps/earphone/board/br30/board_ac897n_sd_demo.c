...
u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    {KEY_MUSIC_PP,   KEY_POWEROFF,  KEY_POWEROFF_HOLD,  KEY_NULL,     KEY_MUSIC_NEXT,     KEY_MODE_SWITCH},   //KEY_0
...
const u8 music_key_table[][KEY_EVENT_MAX] = {
    // SHORT           LONG              HOLD           UP              DOUBLE           TRIPLE
    {KEY_MUSIC_PP,   KEY_POWEROFF,  KEY_POWEROFF_HOLD,  KEY_NULL,     KEY_MUSIC_NEXT,   KEY_MODE_SWITCH},
