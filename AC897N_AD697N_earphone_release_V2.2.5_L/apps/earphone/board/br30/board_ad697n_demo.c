...
STATUS_CONFIG status_config = {
    //灯状态设置
    .led = {//LED0 红灯   LED1 蓝灯
        .charge_start  = PWM_LED0_ON,
        .charge_full   = PWM_LED_ALL_OFF,
        .power_on      = PWM_LED0_LED1_FAST_FLASH,
        .power_off     = PWM_LED0_FLASH_TWO/* PWM_LED0_FLASH_TWO */,
        .lowpower      = PWM_LED0_ONE_FLASH_5S,
        .max_vol       = PWM_LED_NULL,
        .phone_in      = PWM_LED1_BREATHE,
        .phone_out     = PWM_LED1_BREATHE,
        .phone_activ   = PWM_LED1_BREATHE,
        .bt_init_ok    = PWM_LED0_LED1_FAST_FLASH,
        .bt_connect_ok = PWM_LED1_BREATHE,
...
#else
        .bt_disconnect = PWM_LED1_ONE_FLASH_5S,
        .tws_connect_ok = PWM_LED1_ONE_FLASH_5S,
#endif
        .tws_disconnect = PWM_LED1_BREATHE,
// #if (CONFIG_TWS_CHANNEL_SELECT == CONFIG_TWS_AS_RIGHT_CHANNEL)
//         .tws_pairing    = PWM_LED0_LED1_FAST_FLASH,//right
// #else
//         .tws_pairing    = PWM_LED1_ONE_FLASH_5S,//left
// #endif
        .music_pause    = PWM_LED1_BREATHE,
        .music_privious = PWM_LED1_BREATHE,
        .music_next     = PWM_LED1_BREATHE,
        .siri           = PWM_LED1_BREATHE,
        .phone_handup   = PWM_LED1_BREATHE,
        ._3_party_comference = PWM_LED1_BREATHE,
    },
    //提示音设置
    .tone = {
        ...
        .tws_connect_ok   = IDEX_TONE_TWS_CONN/* IDEX_TONE_TWS_CONN */,
        .tws_disconnect   = IDEX_TONE_NONE/* IDEX_TONE_TWS_DISCONN */,
        .music_privious = IDEX_TONE_DU,
        .music_next     = IDEX_TONE_DU,
    }
};
...
u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    {KEY_ONCE_TOUCH,   KEY_POWEROFF,  KEY_POWEROFF_HOLD,  KEY_TOUCH_UP,     KEY_DOUBLE_TOUCH,     KEY_TRIPLE_TOUCH ,KEY_NULL ,KEY_ENTER_DUT},   //KEY_0
...
/* static void get_dac_a_d_gain(void *priv)
{
    audio_gain_dump();
} */
...
void board_init()
{
    ...
    /* sys_timer_add(NULL , get_dac_a_d_gain ,2000); */
