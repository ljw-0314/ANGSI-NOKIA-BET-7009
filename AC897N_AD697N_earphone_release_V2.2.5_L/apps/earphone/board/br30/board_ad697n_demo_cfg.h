...
//                                 iokey 配置                                      //
//*********************************************************************************//
#define TCFG_IOKEY_ENABLE					1//ENABLE_THIS_MOUDLE //是否使能IO按键
...
#define TCFG_AUDIO_DAC_LDO_VOLT				DACVDD_LDO_1_30V/* DACVDD_LDO_1_25V */
/*
DAC硬件上的连接方式,可选的配置：
...
#define TCFG_AUDIO_CVP_NS_MODE				CVP_DNS_MODE//CVP_ANS_MODE
...
// AUTOMUTE
#define AUDIO_OUTPUT_AUTOMUTE   0//DISABLE_THIS_MOUDLE
...
//                                  充电仓配置                                     //
//*********************************************************************************//
#define TCFG_CHARGESTORE_ENABLE				0//ENABLE_THIS_MOUDLE       //是否支持智能充点仓
...
//                                  LED 配置                                       //
//*********************************************************************************//
#define TCFG_PWMLED_ENABLE					1//ENABLE_THIS_MOUDLE			//是否支持PMW LED推灯模块
#define TCFG_PWMLED_IOMODE					LED_ONE_IO_MODE				//LED模式，单IO还是两个IO推灯
#define TCFG_PWMLED_PIN						IO_PORTB_08					//LED使用的IO口
//*********************************************************************************//
//                                  时钟配置                                       //
//*********************************************************************************//
...
//                                  系统配置                                         //
//*********************************************************************************//
#define TCFG_AUTO_SHUT_DOWN_TIME		          (5 * 60)/* 180 */   //没有蓝牙连接自动关机时间
...
#define TCFG_WAV_TONE_MIX_ENABLE		1 // wav提示音叠加播放
...
#define CONFIG_BT_CALL_HZ		        (48 * 1000000L)/* 48 */
#define CONFIG_BT_CALL_ADVANCE_HZ       (64 * 1000000L)/* 64 */
#define CONFIG_BT_CALL_16k_HZ	        (48 * 1000000L)/* 64 */
#define CONFIG_BT_CALL_16k_ADVANCE_HZ   (768 * 100000L) //76.8MHz/* 768 */
#define CONFIG_BT_CALL_DNS_HZ           (96 * 1000000L)/* 96 */
//*********************************************************************************//
//                                 配置结束                                        //
//*********************************************************************************//
