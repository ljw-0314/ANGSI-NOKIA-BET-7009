...
void gx8002_uart_spp_ota_init(void);
...
static void gx8002_sdfile_update_timer(void *priv)
{
    ...
    os_taskq_post_msg(THIS_TASK_NAME, 1, GX8002_MSG_UPDATE);
}
...
void gx8002_npu_version_check(void)
{
    if (__this->state == GX8002_STATE_WORKING) {
        __this->idle = 0;
